...
var locations = {
	...
	vila = "Voltei para a vila de Majula, porém meu dever nao acabou, peguei o caminho dos covardes, devo concluir minha missão e terminar o que comecei na [color=orange]caverna[/color]"
}
...
func _physics_process(delta):
	$GUI_CurrentLocation.text = current_location
